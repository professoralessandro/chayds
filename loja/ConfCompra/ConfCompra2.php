...
{
echo "
<li id='nome_menu1'><a href='#'>".$_SESSION['usuarioNome']."</a>
...
<p>&nbsp;</p>
<div class="form_menu">
<table width="1200" align="center" bgcolor="#EEEEEE" class="read_div_usu">
<tr>
<td align="right"><h1 style="color:#024631">INFORMAÇÕES</h1></td><td align="left"><h1 style="color:#024631">&nbsp;COMPRA CHAYD`S</h1></td>
</tr>
<tr>
...
<tr>
	<td align="right"><h3>Valor do frete: </h3></td><td align="center"><h4><?php
$valFrete = $ft->valFrete;
if($valFrete < 1)
{
	$existeFrete = false;
}
ExisteFrete($existeFrete);
echo $ft->valFrete; ?></h4></td><input hidden="" name="valFrete" value="<?php echo moeda($ft->valFrete); ?>"  />
</tr>
<tr>
