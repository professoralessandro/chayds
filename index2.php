  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
           <!-- BOTOES ADICIONAIS
            ...
            <li class="nav-item"> <a class="nav-link" href="#"><img class="rounded-circle" src='images/33658.png' alt="Loja" width="30" height="30" id="imagem" title="Loja" />&nbsp;Loja</a> </li>
            <li class="nav-item"> <a class="nav-link" href="Classes/View/Contato/ContatoChayds.php"><img title="Suporte" class="rounded-circle" src="images/support.png" width="30" height="30" />&nbsp;Contato</a></li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<?php
				if(isset($_SESSION['usuarioNome']) && $_SESSION['usuarioNome'] != null)
				{ ?>
					<img class="rounded-circle" src='<?php echo "imagens/".$_SESSION['usuarioImagem'];?>' alt="foto de perfil" width="43" height="33" id="imagem" title="foto de perfil" />
		...
		<?php } ?>
			<tr align="center">
				...
				else
				{
					...
					<img class="rounded-circle" src="imagens/profile.png" alt="foto de perfil" width="43" height="33" id="imagem" title="foto de perfil" />
					<?php echo("Usuário"); ?>
					</a>
	<div align="center" class="dropdown-menu" aria-labelledby="navbarDropdown">
		...
		<table align="center">
            ...
            <li class="nav-item">
              <a class="nav-link" href='Classes/View/Videos/Videos.php'><img title="YouTube" class="rounded-circle" src="images/quanto-custa-anunciar-no-youtube.png" width="30" height="30" />&nbsp;Vídeos</a>
            </li>
		  <!-- IMAGENS
		    <li class="nav-item">
