...
<tr>
   ...
   <td align="center"><h3>Código do departamento</h3></td>
	   <td align="center"><h3>Nome do departamento</h3></td>
	   <td align="center"><h3>Nome do gerente</h3></td>
   </tr>
 <?php 
...
$cont = 0;
	 ...
	 { ?>
<div class="read_div_usu" style=>
   <tr>
   <td align="center"><?php $cont = $cont + 1; echo $cont; ?></td>
	   <td align="center"><?php echo $dados['cod_depart']; ?></td>
	   <td align="center"><?php echo $dados['nome_depart']; ?></td>
	   <td align="center"><?php echo $dados['geren_depart']; ?></td><td align="center"><a href='../alterar/alt_depart.php?id_depart=<?php echo $dados['id_depart'];?>'><input name="alterar" type="submit" id="Alterar" value="Alterar" ></a></td>&nbsp;&nbsp;<td align='center'><a onclick="return conf();" href='../../bd/delete/del_depart.php?id_depart=<?php echo $dados['id_depart'];?>'><input name='deletar' type='submit' value='Deletar' >
 </a></td></br>
   </tr>
    </div>
     <?php } ?>
