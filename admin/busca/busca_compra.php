...
<table style="margin: auto" class="form_menu2" bgcolor="#EEEEEE" align="center">
<div>
<tr>
   <td align="center"><h3>Cod Compra</h3></td>
	   <td align="center"><h3>Nome do produto</h3></td>
	   <td align="center"><h3>Nome usuário</h3></td>
       <td align="center"><h3>Status do produto</h3></td>
       <td align="center"><h3>Data</h3></td>
   </tr>
 <?php 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_comp_usu, dt_comp_usu, status_comp_usu, nome_comp_usu, nome_prod_usu FROM tb_compra";
...
$cont = 0;
   ...
   <tr>
   <td align="center"><?php echo $dados['id_comp_usu']; ?></td>
	   <td align="center"><?php echo $dados['nome_prod_usu']; ?></td>
	   <td align="center"><?php echo $dados['nome_comp_usu']; ?></td>
       <td align="center"><?php $status = $dados['status_comp_usu']; 
	   		if($status == '0')
			{
	   ...
	   ?></td>
       <td align="center"><?php echo $dados['dt_comp_usu']; ?></td>
       <td align="center"><a href='../alterar/alt_compra.php?id_comp_usu=<?php echo $dados['id_comp_usu'];?>'><input name="alterar" type="submit" value="Alterar" ></a></td><td align="center"><a onClick="return conf();" href='../../bd/delete/del_compra.php?id_comp_usu=<?php echo $dados['id_comp_usu'];?>'><input type="submit" value="Deletar" name="deletar" ></a></td></br>
   </tr>
    </div>
     <?php } ?>
