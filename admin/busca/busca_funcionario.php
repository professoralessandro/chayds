...
<tr>
   <td align="center"><h3>Contador</h3></td>
	   <td align="center"><h3>Nome do funcionário</h3></td>
	   <td align="center"><h3>Código "NRA"</h3></td>
	   <td align="center"><h3>Cargo</h3></td>
   </tr>
 <?php 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_func, nome_func, num_registro_func, cargo_func FROM tb_funcionario";
...
<div>
   ...
   <td align="center"><?php $cont = $cont + 1; echo $cont; ?></td>
	   <td align="center"><?php echo $dados['nome_func']; ?></td>
	   <td align="center"><?php echo $dados['num_registro_func']; ?></td>
	   <td align="center"><?php echo $dados['cargo_func']; ?></td><td align="center"><a href='../alterar/alt_funcionario.php?id_func=<?php echo $dados['id_func'];?>'><input name='alterar' type='submit' value="Alterar" ></a></td>&nbsp;&nbsp;<td align="center"><a onclick="return conf();" href='../../bd/delete/del_funcionario.php?id_func=<?php echo $dados['id_func'];?>'><input type='submit' value='Deletar' name='deletar' ></a></td></br>
   </tr>
    </div>
     <?php } ?>
