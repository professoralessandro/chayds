...
<tr>
   <td align="center"><h3>Contador</h3></td>
	   ...
	   <td align="center"><h3>Código interno</h3></td>
   </tr>
 <?php 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_prod, nome_prod, cod_inter_prod FROM tb_produto";
...
<div>
   ...
   <td align="center"><?php $cont = $cont + 1; echo $cont; ?></td>
	   <td align="center"><?php echo $dados['nome_prod']; ?></td>
	   <td align="center"><?php echo $dados['cod_inter_prod']; ?></td><td align="center"><a href='../alterar/alt_produto.php?id_prod=<?php echo $dados['id_prod'];?>'><input name="alterar" type="submit" value="Alterar" ></a></td><td align="center"><a onclick="return conf();" href='../../bd/delete/del_produto.php?id_prod=<?php echo $dados['id_prod'];?>'><input type="submit" value="Deletar" name="deletar" ></a></td></br>
   </tr>
    </div>
     <?php } ?>
