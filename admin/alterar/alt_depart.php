...
$sqlcomand = "SELECT id_func,email_func,nome_func FROM tb_funcionario
WHERE cargo_func LIKE '%Gerente%'";

$sql = "SELECT * FROM tb_departamento WHERE $id_depart";
$resultado = mysqli_query($conn, $sql) or die ("Erro ao consultar os dados na base.");
while($dados = mysqli_fetch_array($resultado))
if($id_depart == $dados['id_depart'])
{
	{  ?>
 <form name="f1" action="../../bd/alter/update_depart.php" target="_self" method="post">
 <table class="form_menu2" bgcolor="#EEEEEE"  align="center">
<tr><td><h3 align="right">ALTERAR DEPARTAMENTO</h3></td><td></td></tr>
 <tr>
 <tr><input hidden='hidden' name='id_depart' value='<?php echo $dados['id_depart']?>' size='35' id='nome_usuario' type='number' maxlength='50'>
   </tr>
    <td align="right" >* Nome do departamento:<font color="#000000"></font></td><td align="left"> 
    <input disabled name='nome_depart' size='35' value='<?php echo $dados['nome_depart'];?>' id='nome_departamento' type='text' maxlength='50'></td></tr>
    <tr>
 <td align="right" >* Gerente do departamento:<font color="#000000"></font></td><td align="left">
 <input disabled="disabled" name='geren_depart' value='<?php echo $dados['geren_depart'];?>' size='35' id='numero_registro_funcionario' type='text' maxlength='50'></li></td></tr>
 <td align="right" >* Código do departamento "NRD":<font color="#000000"></font></td><td align="left"> 
 <input disabled='disabled' name='cod_depart' value='<?php echo $dados['cod_depart'];?>' size='35' id='numero_registro_funcionario' type='text' maxlength='60'></li></td></tr>

<tr>
 <td align="right" >* Email do departamento:<font color="#000000"></font></td><td align="left">
        <input disabled="disabled" name="email_depart" size="35" value='<?php echo $dados['email_depart'];?>' id="Email comercial " type="email" maxlength="60"> 
    </li></td></tr>

<tr>
 <td align="right" >* Email comercial do departamento:<font color="#000000"></font></td><td align="left">
        <input name="email_comer_depart" size="35" value='<?php echo $dados['email_comer_depart'];?>' placeholder="Digite o email comercial(obrigatório)" id="Email comercial " type="email" maxlength="60"> 
    </li></td></tr>
 </tr>
 <tr>
 <td align="right" >* Telefone do departamento:<font color="#000000"></font></td><td align="left">
        <input name="tel_depart" value='<?php echo $dados['tel_depart'];?>' placeholder="Telefone principal: (13)996xx-xxxx (obrigatório)" size="35" id="telefone_departamento" type="number" maxlength="15"> 
    </li></td></tr>
 </tr>
 <tr>
      <td align="right" >* Data de criação do departamento:<font color="#000000"></font></td><td align="left">
    <input disabled name="data_depart" value='<?php echo $dados['data_depart'];?>' id="data_nasc_departamento" type="date"></li></td></tr>
    <tr></tr>
    <tr>
      <td></td><td><a href='../../bd/alter/update_depart.php?id_depart=<?php echo $dados['id_depart']?>'><input type='submit' value='Alterar' name='alterar' id='alterar'></a></td>
<?php }
} mysqli_close($conn); ?>
</tr>
<tr>
