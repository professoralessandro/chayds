...
$sql = "SELECT id_func, nome_func, num_registro_func, num_rg_func, num_cpf_func FROM `tb_funcionario`";
$resultado = mysqli_query($conn, $sql) or die ("Erro ao consultar os dados na base.");
	 while($dados = mysqli_fetch_array($resultado))
if($id_func == $dados['id_func'])
{
	{  ?>
 <form name="f1" action='../../bd/alter/update_funcionario.php' target="_self" method="post">
 <table class="form_menu2" bgcolor="#EEEEEE" align="center">
<tr><td border="1"><h3 align="right">ALTERAR FUNCIONÁRIO</h3></td><td></td></tr>
<tr><input hidden='hidden' name='id_func' value='<?php echo $dados['id_func']?>' size='35' id='id_funcionario' type='number' maxlength='50'>
   </tr>
<tr>
    <td align="right">* Nome:<font color="#000000"></font></td><td align="left"><!--Campo Unique, not nul -->
    <input disabled="disabled" name="nome_func" value='<?php echo $dados['nome_func']?>' size="40" id="nome_cliente" type="text" maxlength="50"> </li></td></tr>
 </tr>
 <tr>
    <td align="right">* Numero do registro "NRA":<font color="#000000"></font></td><td align="left"> 
    <input disabled="disabled" name="num_registro_func" value='<?php echo $dados['num_registro_func']?>' size="40" id="numero_registro_funcionario" type="number" maxlength="16"></li></td></tr>
    <tr>
    <td align="right">*RG:<font color="#000000"></font></td><td align="left"> 
    <input disabled="disabled" name="num_rg_func" value='<?php echo $dados['num_rg_func']?>' size="40" id="num rg func" type="text" maxlength="18"></li></td></tr>
    <tr>
    <td align="right">*CPF:<font color="#000000"></font></td><td align="left"> 
    <input disabled="disabled" name="num_cpf_func" value='<?php echo $dados['num_cpf_func']?>' size="40" id="numero_cpf_funcionario" type="text" maxlength="18"></li></td></tr>
<?php }
} ?>
 <tr>
...
//$id_func = filter_input(INPUT_GET, 'id_func', FILTER_SANITIZE_NUMBER_INT); 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_func, data_nasc_func, escol_func FROM `tb_funcionario`";
$resultado = mysqli_query($conn, $sql) or die ("Erro ao consultar os dados na base.");
	 while($dados = mysqli_fetch_array($resultado))
if($id_func == $dados['id_func'])
{
    ...
    <input disabled="disabled" name="data_nasc_func" value='<?php echo $dados['data_nasc_func']?>' id="data_nasc_funcionario" type="date"></li></td></tr>
    <tr>
    <td align="right">*Escolaridade:<font color="#000000"></font></td><td align="left"> 
    <input name="escol_func" value='<?php echo $dados['escol_func']?>' placeholder="Escolaridade do funcionário (obrigatório)" size="40" id="cargo do funcionario" type="text" maxlength="35"></li></td></tr>
    <tr>
...
//$id_func = filter_input(INPUT_GET, 'id_func', FILTER_SANITIZE_NUMBER_INT); 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_func, email_func, tel_func_1, tel_func_2, senha_func FROM `tb_funcionario`";
$resultado = mysqli_query($conn, $sql) or die ("Erro ao consultar os dados na base.");
	 while($dados = mysqli_fetch_array($resultado))
if($id_func == $dados['id_func'])
{
 ...
 <tr>
    ...
    <input name="email_func" size="40" value='<?php echo $dados['email_func']?>' placeholder="Email do funcionário(obrigatório)" id="email_func" type="email" maxlength="60"></li></td></tr>
    <tr>
      <td align="right">* Telefone 1:<font color="#000000"></font></td><td align="left">
    <input name="tel_func_1" value='<?php echo $dados['tel_func_1']?>' placeholder="Telefone 1 do funcionário: (13)996xx-xxxx (obrigatório)" size="40" id="Funcionario 1" type="number" maxlength="15"></li></td></tr>
    <tr>
      <td align="right">Telefone 2:<font color="#000000"></font></td>
      <td align="left">
    <input name="tel_func_2" value='<?php echo $dados['tel_func_2']?>' placeholder="Telefone 2 do funcionário: (13)996xx-xxxx" size="40" id="tel_funcionario 2" type="number" maxlength="15"></li></td></tr>
    <tr>
      <td align="right">* Senha:<font color="#000000"></font></td><td align="left">
    <input name="senha_func" value='<?php echo $dados['senha_func']?>' placeholder="Sua senha (obrigatório)" size="40" id="senha_cliente" type="password" maxlength="16"></li></td></tr>
    <tr>
      <td align="right">* Confirmar Senha:<font color="#000000"></font></td><td align="left">
    <input name="conf_senha_func" value='<?php echo $dados['senha_func']?>' placeholder="Confirmar sua senha (obrigatório)" size="40" id="senha_cliente" type="password" maxlength="16"></li></td></tr>
<?php }
} ?>
 <tr>
...
//$id_func = filter_input(INPUT_GET, 'id_func', FILTER_SANITIZE_NUMBER_INT); 
	 include_once("../../bd/conexao/conexao.php");
$sql = "SELECT id_func, end_func, complemento_func, bairro_func, cidade_func, estado_func,cep_func, data_contrat, coment_func, data_demis, coment_func_demis FROM `tb_funcionario`";
$resultado = mysqli_query($conn, $sql) or die ("Erro ao consultar os dados na base.");
	 while($dados = mysqli_fetch_array($resultado))
if($id_func == $dados['id_func'])
{
 ...
 <td align="right">* Endereço</br>"Logradouro e numero":<font color="#000000"></font></td><td align="left">
        <input name="end_func" value='<?php echo $dados['end_func']?>' placeholder="Logradouro do funcionário (obrigatório)" size="40" id="endereço_departamento" type="text" maxlength="40"> 
    </li></td></tr>
    <tr>
 <td align="right">Complemento:<font color="#000000"></font></td><td align="left">
        <input name="complemento_func" value='<?php echo $dados['complemento_func']?>'placeholder="Complemento" size="40" id="bairro_departamento" type="text" maxlength="35"> 
    </li></td></tr>
 <tr>
 <td align="right"> Bairro:<font color="#000000"></font></td><td align="left">
        <input name="bairro_func" value='<?php echo $dados['bairro_func']?>' placeholder="Bairro" type="text" maxlength="35"> 
    </li></td></tr>
 <tr>
 <td align="right">* Cidade:<font color="#000000"></font></td><td align="left">
        <input name="cidade_func" value='<?php echo $dados['cidade_func']?>' placeholder="Cidade (obrigatório)" size="40" id="cidade_funcionario" type="text" maxlength="35">
    </li></td></tr>
 </tr>
 <tr>
 ...
 <td align="right">* CEP:<font color="#000000"></font></td><td align="left">
        <input name="cep_func" value='<?php echo $dados['cep_func']?>' placeholder="CEP (obrigatorio)" size="40" id="cep_cepartamento" type="text" maxlength="9"> 
    </li></td></tr>
 </tr>
 <tr>
      <td align="right">* Data de contratação:<font color="#000000"></font></td><td align="left">
    <input disabled="disabled" name="data_contrat" value='<?php echo $dados['data_contrat']?>' id="data_contratação" type="date" maxlength="10"></li></td></tr>
    <tr>
      <td align="right">Data de demissão:<font color="#000000"></font></td><td align="left">
    <input name="data_demis" value='<?php echo $dados['data_demis']?>' placeholder="Dara de demissão" id="data_demissao" type="date" maxlength="10"></li></td></tr><!-- Adicionar uma função para demitir o funcionário, add campo demissao na tabeça nao obrigatório -->
    <tr>
      <td align="right">Comentários adicionais:<font color="#000000"></font></td><td align="left"><textarea name="coment_func" value='<?php echo $dados['coment_func']?>' placeholder="Comentários adicionais sobre o funcionário" id="coment_func" cols="42" rows="4" maxlength="220"></textarea></li></td></tr>
      <tr>
      <td align="right">Comentários sobre a demissão:<font color="#000000"></font></td><td align="left"><textarea name="coment_func_demis" value='<?php echo $dados['coment_func_demis']?>' placeholder="Comentários adicionais sobre a demissão" id="coment_func" cols="42" rows="4" maxlength="220"></textarea></li></td></tr>
    <tr>
      <td></td><td><input type="submit" value="Alterar" name="alterar" id="enviar" ></td>
<?php }
} ?>
</tr>
<tr>
