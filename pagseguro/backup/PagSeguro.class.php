<?php
class PagSeguro{
	private $email         = "professor_alessandro@hotmail.com";
	private $token_sandbox = "BC4F456821414523B1D3F14D193F909B";
	private $token_oficial = "0086EE139A3E430C927303E419646416";
	private $url_retorno   = "http://www.chayds.com.br/pagseguro/notificacao.php";
	...
	private function generateUrl($dados,$retorno){
		...
		//Itens
		$data['itemId1'] = '0001';
		$data['itemDescription1'] = "Item Teste";$dados['descricao'];
		$data['itemAmount1'] = '300.00';//number_format($dados['valor'],2,".","");
		...
		$data['senderName'] = "Alessandro dos Santos";//$dados['nome'];
		$data['senderAreaCode'] = "013";//$ddd;
		$data['senderPhone'] = "996442358";//$telefone;
