...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
	...
	if(isset($_POST['cadastrar']) && $_POST['cadastrar'] != null)
	{
		...
		{
			//VERIFICA TAMANHO FOTO
			if($size > 1 || $size < 40001)
			{
				//IF SENHAS
				if($_POST['senha'] == $_POST['confirmarSenha'])
				{
					$empresa = new Empresa(1, $nome, $cpf, $dataNascimento, $dataCadastro, $email, $nivelAcesso, $ddd, $telefone, $ddd2, $telefone2, $endereco, $complemento, $bairro, $cidade, $estado, $cep, $sexo, $senha, $imagem);
					...
					$cadastroOK = $dalEmpresa->cadastrarEmpresa($empresa);
					...
					if($cadastroOK)
					{
						...
						alert(\"A empresa $nome foi cadastrada com sucesso.\");
						</script>";
					}
					else
					{
						echo "<META HTTP-EQUIV=REFRESH CONTENT ='0;URL=http://www.chayds.com.br/Classes/View/Cadastro/CadastroEmpresa.php'>
						<script type= \"text/javascript\">
		...
		else
		{
				...
				<script type= \"text/javascript\">
				alert(\"Erro ao cadastrar a empresa. Por favor verifique os campos obrigatórios e tente novamente\");
				</script>";
		}//CAMPOS OBRIGATORIOS
	}
	...
	<form name="formCadastrarEmpresa" action="#" target="_self" method="post" enctype="multipart/form-data">
		<div class="container" align="center">
		  <table class="form_menu2" align="center">
			<tr>
              ...
              <img title="cpf" class="rounded-circle" src="../../../images/1246548.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="cpf" type="text" required="required" id="cpf" placeholder="Informe o CNPJ" title="CPF" size="25" maxlength=50">&nbsp;
		  </td>
		  ...
		  <table class="form_menu2" align="center">
			...
			<td align="center"><label for="telefone"><font class="font-weight-bold" color="#ff0000">*</font>
              <img title="telefone" class="rounded-circle" src="../../../images/icon_phone2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="telefone" type="text" required="required" id="telefone" placeholder="Informe o seu telefone" title="Telefone" size="25" maxlength=50">&nbsp;
            </td>
			</tr>
			<tr>
			<td><p>&nbsp;</p></td>
			...
			<tr>
              ...
              <img title="ddd2" class="rounded-circle" src="../../../images/icon_phone2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="ddd2" type="text" required="required" id="ddd2" placeholder="Informe o DDD2" title="DDD2" size="10" maxlength=50">&nbsp;
          </td>
			  <td align="center"><label for="telefone2">
              <img title="telefone2" class="rounded-circle" src="../../../images/icon_phone2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="telefone2" type="text" required="required" id="telefone2" placeholder="Informe o celular" title="Telefone" size="25" maxlength=50">&nbsp;
            </td>
		  </table>
		  <table class="form_menu2" align="center">
			<tr>
        ...
        <tr>
          ...
          <td align="center"><label for="confirmarSenha"><font class="font-weight-bold" color="#ff0000">*</font>
              <img title="confirmarSenha" class="rounded-circle" src="../../../images/lock2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="confirmarSenha" type="password" required="required" id="confirmarSenha" placeholder="Repita a senha" title="Confirmar senha" size="25" maxlength=50">&nbsp;
		  </td>
        </tr>
        <tr>        
      </table>
