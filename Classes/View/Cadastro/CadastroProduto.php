	...
	<form name="formCadastroProduto" action="#" target="_self" method="post" enctype="multipart/form-data">
		<div class="container" align="center">
		  <table class="form_menu2" align="center">
			<tr>
			  <td align="center"><h5><font color="#ff0000">*</font> Nome do produto: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="nomeProduto" type="text" required="required" id="nomeProduto" placeholder="Informe o nome do produto (Obrigatório)" title="Nome do Produto" size="40" maxlength=240">
			  </blockquote>
			  </td>
				<td align="center"><h5><font color="#ff0000">*</font> Descrição principal do produto: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="descricaoProduto" type="text" required="required" id="descricaoProduto" placeholder="Descrição do produto (Obrigatório)" title="Descrição do produto" size="40" maxlength=250>
			  </blockquote></td>
			  <td align="center"><h5><font color="#ff0000">*</font> Quantidade: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="quantidade" type="number" required="required" id="quantidade" placeholder="Informe a quantidade (Obrigatório)" title="Quantidade" size="15" maxlength=50">
			  </blockquote>
			  </td>
			</tr>
			<tr>        
			<tr>
			  <td align="center"><h5><font color="#ff0000">*</font> Estoque Mínimo: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="estoqueMinimo" type="number" required="required" id="estoqueMinimo" placeholder="Informe o estoque mínimo (Obrigatório)" title="Estoque minimo" size="15" maxlength=50">
			  </blockquote>
			  </td>
			  <td align="center"><h5><font color="#ff0000">*</font> Altura: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="altura" type="number" required="required" id="altura" placeholder="Informe a altura (Obrigatório)" title="Altura" size="15" maxlength=50">
			  </blockquote>
			  </td>
			  <td align="center"><h5><font color="#ff0000">*</font> Largura: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="largura" type="number" required="required" id="largura" placeholder="Informe a largura (Obrigatório)" title="Largura" size="15" maxlength=50">
			  </blockquote>
			  </td>
			</tr>
			<tr>
			  <td align="center"><h5><font color="#ff0000">*</font> Comprimento: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="comprimento" type="number" required="required" id="comprimento" placeholder="Informe o comprimento (Obrigatório)" title="Comprimento" size="15" maxlength=50">
			  </blockquote>
			  </td>
			  <td align="center"><h5><font color="#ff0000">*</font> Peso: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="peso" type="text" required="required" id="telefone" placeholder="Infome o peso (Obrigatório)" title="Peso" size="20" maxlength=50">
			  </blockquote></td>
			  <td align="center"><h5>Público Alvo: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="publicoAlvo" type="text" id="celular" placeholder="Informe o público alvo (Obrigatório)" title="Público Alvo" size="40" maxlength=50">
			  </blockquote></td>
			</tr>
			<tr>
			  <td align="center"><h5><font color="#ff0000">*</font> Código de Barras: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="codigoBarras" type="text" required="required" id="telefone" placeholder="Informe o código de barras (Obrigatório)" title="Código de Barras" size="40" maxlength=50">
			  </blockquote></td>
			  ...
			  <td align="center"><h5><font color="#ff0000">*</font> Preço de Custo: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="precoCusto" type="text" required="required" id="preco_custo" placeholder="Digite o nome preço de custo EX. R$15,99 (obrigatório)" title="Preço de custo" size="20" maxlength="50">
			  </blockquote></td>
			</tr>
			<tr>
				...
				<font color="#000000">
				<blockquote>
				  <input name="precoVenda" type="text" required="required" id="preco_venda" placeholder="Digite o preço de venda EX. R$20,99 (obrigatório)" title="Preço de venda" size="20" maxlength="50">
			  </blockquote></td>
			  <td align="center"><h5>Preço com Desconto: </h5>
				<blockquote>
				  <input name="precoDesconto" type="text" id="Email" placeholder="Digite o preço de venda EX. R$20,99 (revendedores)" title="Preço com Desconto" size="20" maxlength=50">
			  </blockquote></td>
			  <td align="center"><h5>Link do Youtube: </h5>
				<font color="#000000">
				<blockquote>
				  <input name="videoYoutube" type="text" id="telefone" placeholder="Informe um link no youtube do seu produto" title="Código de Barras" size="60" maxlength=200">
			  </blockquote></td>
			  </tr>
			  <tr>
		...
		<table align="center">
		  <tr>
			  <td align="center"><h5>Primeiro título</h5>
				<font color="#000000">
				<blockquote>
				  <input name="titulo1" type="text" id="descricaoProduto" placeholder="Informe um título de um propriedade do produro" title="Primeiro título" size="35" maxlength=50>
			  </blockquote></td>
			  <td align="center"><h5>Segundo título</h5>
				<font color="#000000">
				<blockquote>
				  <input name="titulo2" type="text" id="titulo1" placeholder="Informe mais um título de um propriedade do produro" title="Segundo título" size="35" maxlength=50>
			  </blockquote></td>
			  <td align="center"><h5>Terceiro título</h5>
				<font color="#000000">
				<blockquote>
				  <input name="titulo3" type="text" id="descricaoProduto" placeholder="Informe mais um título de um propriedade do produro" title="Terceiro título" size="35" maxlength=50>
			  </blockquote></td>
			  <td align="center"><h5>Quarto título</h5>
				<font color="#000000">
				<blockquote>
				  <input name="titulo4" type="text" id="descricaoProduto" placeholder="Informe mais um título de um propriedade do produro" title="Quarto título" size="35" maxlength=50>
			  </blockquote></td>
		 </tr>
		 <tr>
