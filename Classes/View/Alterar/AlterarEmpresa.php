...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
	...
	$dalEmpresa = new DALEmpresa($conexao);
		...
		if(isset($_POST['nome']) && $_POST['nome'] != null  && isset($_POST['nivelAcesso']) && $_POST['nivelAcesso'] != null && isset($_POST['ddd']) && $_POST['ddd'] != null && isset($_POST['email']) && $_POST['email'] != null && isset($_POST['telefone']) && $_POST['telefone'] != null && isset($_POST['endereco']) && $_POST['endereco'] != null && isset($_POST['cidade']) && $_POST['cidade'] != null && isset($_POST['estado']) && $_POST['estado'] != null && isset($_POST['cep']) && $_POST['cep'] != null && isset($_POST['senha']) && $_POST['senha'] != null && isset($_POST['confirmarSenha']) && $_POST['confirmarSenha'] != null)
		{
			if($size > 1 || $size < 40001)
			{
				...
				if($_POST['senha'] == $_POST['confirmarSenha'])
				{
					...
					{
						$empresa = new Empresa($idEmpresa, $nome, '', '', '', $email, $nivelAcesso, $ddd, $telefone, $ddd2, $telefone2, $endereco, $complemento, $bairro, $cidade, $estado, $cep, '', $senha, $imagemNova);
					...
					{
						$empresa = new Empresa($idEmpresa, $nome, '', '', '', $email, $nivelAcesso, $ddd, $telefone, $ddd2, $telefone2, $endereco, $complemento, $bairro, $cidade, $estado, $cep, '', $senha, $imagemAnt);
					}
					else if($imagemAnt == null && $imagemNova == null)
					{
						$empresa = new Empresa($idEmpresa, $nome, '', '', '', $email, $nivelAcesso, $ddd, $telefone, $ddd2, $telefone2, $endereco, $complemento, $bairro, $cidade, $estado, $cep, '', $senha, "profile.png");
					}
					...
					$cadastroOK = $dalEmpresa->alterarEmpresa($empresa);

					if(!$cadastroOK)
					{
						echo "<META HTTP-EQUIV=REFRESH CONTENT ='0;URL=http://www.chayds.com.br/index.php'>
						<script type= \"text/javascript\">
						alert(\"A empresa $nome foi alterada com sucesso.\");
						</script>";
					}//ALTERAR OK
					else
					{
						echo "<META HTTP-EQUIV=REFRESH CONTENT ='0;URL=http://www.chayds.com.br/Classes/View/Alterar/AlterarEmpresa.php'>
						<script type= \"text/javascript\">
						alert(\"Erro ao alterar os dados da empresa. Tente novamente\");
						</script>";
					}//ALTERAR OK
				}
				else
				{
					echo "<META HTTP-EQUIV=REFRESH CONTENT ='0;URL=http://www.chayds.com.br/Classes/View/Alterar/AlterarEmpresa.phpa'>
					<script type= \"text/javascript\">
					alert(\"Erro ao cadastrar a empresa. Por favor verifique as senhas e tente novamente\");
					</script>";
				}//IF SENHAS
			...
			else
			{
				echo "<META HTTP-EQUIV=REFRESH CONTENT ='0;URL=http://www.chayds.com.br/Classes/View/Alterar/AlterarEmpresa.php'>
				<script type= \"text/javascript\">
				alert(\"Erro ao alterar a empresa. O tamanho do arquivo deve ter até 4MB\");
				</script>";
			}//TAMANHO
  ...
  <body>
	...
	<?php
		...
		<hr>
	<?php
		$resultado = $dalEmpresa->localizarEmpresa($id);

		$dados = mysqli_fetch_array($resultado);
	?>
		<hr>
	<input hidden="" name="idEmpresa" type="text" required="required" id="nome" value='<?php echo $id ?>' placeholder="Informe o seu nome completo (obrigatório)" title="Nome" size="40" maxlength=50">
	<form name="formCadastrarEmpresa" action="#" target="_self" method="post" enctype="multipart/form-data">
		<div class="container" align="center">
		  <table class="form_menu2" align="center">
			<tr>
              ...
              <img title="cpf" class="rounded-circle" src="../../../images/1246548.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' disabled="disabled" name="cpf" type="text" id="cpf" placeholder="Informe o CNPJ" title="CPF" value='<?php echo $dados['cnpj'];?>' size="25" maxlength=50">&nbsp;
		  </td>
			  <td align="center"><label for="dataNascimento"><font class="font-weight-bold" color="#ff0000">*</font>
              <img title="dataNascimento" class="rounded-circle" src="../../../images/61469.svg" width="35" height="37" /></label>&nbsp;<input name="dataNascimento" type="date" disabled="disabled" class='btn btn-group border-0 text-center font-weight-bold' id="dataNascimento" placeholder="Informe o seu email (obrigatório)" title="data de nascimento" value='<?php echo $dados['dataNascimento'];?>' size="25 maxlength=50">&nbsp;
			</td>
			</tr>
			<tr>        
			<tr>
              ...
              <img title="Email" class="rounded-circle" src="../../../images/email3.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="email" type="email" required="required" id="email" placeholder="Informe o seu email" title="email" value='<?php echo $dados['email'];?>' size="25" maxlength=50">&nbsp;
			  </td>
		  ...
		  <table class="form_menu2" align="center">
			...
			<tr>
              ...
              <img title="ddd2" class="rounded-circle" src="../../../images/icon_phone2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="ddd2" type="text" required="required" id="ddd2" placeholder="Informe o DDD2" title="DDD2" value='<?php echo $dados['ddd2'];?>' size="10" maxlength=50">&nbsp;
          	</td>
			  <td align="center"><label for="telefone2">
              <img title="telefone2" class="rounded-circle" src="../../../images/icon_phone2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="telefone2" type="text" required="required" id="telefone2" placeholder="Informe o celular" title="Telefone" value='<?php echo $dados['celular'];?>' size="25" maxlength=50">&nbsp;
            </td>
			</tr>
		  </table>
		  <table class="form_menu2" align="center">
		  ...
		  <table class="form_menu2" align="center">
			...
			<tr>
              ...
              <img title="confirmarSenha" class="rounded-circle" src="../../../images/lock2.png" width="35" height="37" /></label>&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="confirmarSenha" type="password" required="required" id="confirmarSenha" placeholder="Repita a senha" title="Confirmar senha" value='<?php echo $dados['senha'];?>' size="25" maxlength=50">&nbsp;
		  	  </td>
			</tr>       
		  </table>
		  <tr>
