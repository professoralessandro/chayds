	...
	{ $contadorCarrinho = $contadorCarrinho + 1; ?>
		...
		<!-- AREA DE SOMA DE CALCULO DE FRETE E CONTADOR DE PRODUTOS -->
		  <td align="center">
			...
			?>
         	<input hidden="" name="idCarrinh" type="text" value='<?php echo $dados['idCompra'];?>' title="Peso" size="40" maxlength=50">
          </td>
		<!-- AREA DE SOMA DE CALCULO DE FRETE E CONTADOR DE PRODUTOS -->
          <td align="left">
          ...
          <td align="center">
       		<a href='ConfirmarCompraAlterar.php?idProduto=<?php echo $dados['idCompra'];?>&nomeCompra=<?php echo $dados['nomeCompra'];?> '><input class="btn btn-primary" name='alterar' type='button' value='alterar' ></a>
		  </td>
		<td align="center">
			  
            <a onclick="return confDeletar();" href='../Busca/ListaCompraDel.php?idProduto=<?php echo $dados['idCompra'];?> '><input class="btn btn-danger" name='deletar' type='button' value='Deletar' ></a>
...
<?php
	...
	//$freteCorrios = new FreteCorreios(20,20,20,15,100,'27410200','37500410','','','n','n','40010');
	if($totAltura < 20)
	{
		$totAltura = 20;
	}
	...
	$freteCorrios = new FreteCorreios($totAltura, $totLargura, $totComprimento, $totPeso, $valCarrinho, $meuCEP, $_SESSION['usuarioCep'], $codigoEmpresa, $senhaEmpresa, $entregaMaos, $avisoRecebmento);
						
	//print_r($freteCorrios);
	
	$valSedex = $dalFreteCorreios->calcularFreteSedex($freteCorrios);
		
	$valPac = $dalFreteCorreios->calcularFretePac($freteCorrios);
?>
...
<input hidden=""  name="isCarrinho" type="text" value='<?php echo true;?>' title="Peso" size="40" maxlength=50">
<table align="center">		
<tr>
	...
	<td align="left">
              <input class="btn btn-outline-success my-2 my-sm-0" name="tipoFrete" type="radio" id="Tipo frete" title="Sedex" value="S">
               SEDEX R$ <?php $sedex = $valSedex->Valor; $valTotsedex = $dalProduto->moeda($sedex) + $valCarrinho; echo($sedex); ?><br>
              <input class="btn btn btn-outline-info my-2 my-sm-0" name="tipoFrete" type="radio" id="Tipo frete" title="Pac" value="P">
             PAC R$ <?php $pac = $valPac->Valor; $valTotPac = $dalProduto->moeda($pac) + $valCarrinho; echo($pac) ?><br>
