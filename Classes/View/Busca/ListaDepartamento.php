...
<hr>
    <h2 class="text-center">BUSCA AVANÇADA DE DEPARTAMENTOS</h2>
    <hr>
<form name="formBuscarUsuario" action="ResultadoBuscaDepartamento.php" target="_self" method="post">
<div align="center" class="jumbotron">
	...
	$resultado = $dalDepartamento->listarDepartamento();
