...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
	...
	if(isset($_POST) && $_POST != null)
	{
		...
		$preco = $dalProduto->moeda($preco);
						
		$resultadoBusca = $dalProduto->localizarProdutoAvancado($data1, $data2, $nome, $preco, $vendas);
...
<hr>
    <h2 class="text-center">BUSCA AVANÇADA DE PRODUTO</h2>
<hr>
<form name="formBuscarUsuario" action="ResultadoBuscaProduto.php" target="_self" method="post">
<div align="center" class="jumbotron">
    <td>
	<font class="font-weight-bold">De</font> &nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="data1" type="date" id="dataNascimento" placeholder="Informe o seu email (obrigatório)" title="data de nascimento" size="20" maxlength=50">&nbsp;<font class="font-weight-bold">Até</font><input class='btn btn-group border-0 text-center font-weight-bold' name="data2" type="date" id="dataNascimento" placeholder="Informe o seu email (obrigatório)" title="data de nascimento" size="20" maxlength=50">&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="nome" type="text" id="nome" placeholder="Nome" title="Nome" size="17" maxlength=50">&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="preco" type="text" id="preco" placeholder=" R$ Preço" title="Preco" size="8" maxlength=50">&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="vendas" type="text" id="preco" placeholder="N de vendas" title="Vendas" size="8" maxlength=50">&nbsp;<button name="buscar" class='btn border-0 text-center font-weight-bold' >
...
<?php
	...
	{ ?>
        <tr>
          ...
          <td align="center">
              <?php echo $dalProduto->virgula($dados['precoVenda']); ?>
          </td>
		  <td align="center">
			  <?php echo $dados['vendas']; ?>
		  </td>
          <td align="center">
       		<a href='../Alterar/AlterarProduto.php?idProduto=<?php echo $dados['idProduto'];?> '><input class="btn btn-primary" name='alterar' type='submit' value='alterar' ></a>
		  </td>
		  <td align="center">
		...
		<!--	<a onclick="return conf();" href='ListaUsuarioInf.php?idPessoa=<?php echo $dados['idPessoa'];?> '><input name='deletar' type='submit' value='Deletar' ></a> -->  
            ...
            <a onclick="return conf();" href='ListaProdutoDel.php?idProduto=<?php echo $dados['idProduto'];?> '><input class="btn btn-danger" name='deletar' type='submit' value='Deletar' ></a>
		  </td>
        </tr>
<?php }
	}
