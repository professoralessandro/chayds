...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
	...
	{ 
		if(isset($_POST['data1']) || isset($_POST['data2']) || isset($_POST['nome']) || isset($_POST['email']))
		{
			...
			$resultadoBusca = $dalDepartamento->localizarDepartamentoAvancado($data1, $data2, $nome, $email, $gerente);
...
<?php
	...
	{ ?>
        <tr>
		  ...
		  <td align="center">
			  <?php echo $dados['gerente']; ?>
		  </td>
          <td align="center">
       		<a href='../Alterar/AlterarDepartamento.php?idDepartamento=<?php echo $dados['idDepartamento'];?> '><input class="btn btn-primary" name='alterar' type='submit' value='alterar' ></a>
		  </td>
		  <td align="center">
		...
		<!--	<a onclick="return conf();" href='ListaUsuarioInf.php?idPessoa=<?php echo $dados['idPessoa'];?> '><input name='deletar' type='submit' value='Deletar' ></a> -->  
            ...
            <a onclick="return conf();" href='ListaDepartamentoDel.php?idDepartamento=<?php echo $dados['idDepartamento'];?> '><input class="btn btn-danger" name='deletar' type='submit' value='Deletar' ></a>
		  </td>
        </tr>
<?php }
	}
