...
<html lang="en">
  ...
  <body>
	...
	<hr>
    <h2 class="text-center">BUSCA AVANÇADA DE FUNCIONÁRIO</h2>
    <hr>
<form name="formBuscarFuncionario" action="ResultadoBuscaFuncionario.php" target="_self" method="post">
<div class="jumbotron">
    <td>
	...
	$resultado = $dalFuncionario->listarFuncionario();
