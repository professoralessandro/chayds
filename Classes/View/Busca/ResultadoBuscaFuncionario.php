...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
	...
	{ 
		if(isset($_POST['data1']) || isset($_POST['data2']) || isset($_POST['nome']) || isset($_POST['email']))
		{
			...
			$resultadoBusca = $dalFuncionario->localizarFuncionarioAvancado($data1, $data2, $nome, $email, $nivelAcesso);
...
<div class="jumbotron">
	...
	<font class="font-weight-bold">De</font> &nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="data1" type="date" id="dataNascimento" placeholder="Informe o seu email (obrigatório)" title="data de nascimento" size="20" maxlength=50">&nbsp;<font class="font-weight-bold">Até</font><input class='btn btn-group border-0 text-center font-weight-bold' name="data2" type="date" id="dataNascimento" placeholder="Informe o seu email (obrigatório)" title="data de nascimento" size="20" maxlength=50">&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="nome" type="text" id="nome" placeholder="Nome" title="Nome" size="17" maxlength=50">&nbsp;<input class='btn btn-group border-0 text-center font-weight-bold' name="email" type="email" id="celular" placeholder="Email" title="email" size="17" maxlength=50">&nbsp;<select class='btn btn-group border-0 text-center font-weight-bold' name="nivelAcesso" id="nivelAcesso" title="Nivel de acesso" type="text">
              ...
              </select>&nbsp;&nbsp;<button name="buscar" class='btn border-0 text-center font-weight-bold' >
...
<?php
	...
	{ ?>
        <tr>
          ...
          <td align="center">
       		<a href='../Alterar/AlterarFuncionario.php?idFuncionario=<?php echo $dados['idFuncionario'];?> '><input class="btn btn-primary" name='alterar' type='submit' value='alterar' ></a>
		  </td>
		  <td align="center">
		...
		<!--	<a onclick="return conf();" href='ListaUsuarioInf.php?idPessoa=<?php echo $dados['idPessoa'];?> '><input name='deletar' type='submit' value='Deletar' ></a> -->  
            ...
            <a onclick="return conf();" href='ListaFuncionarioDel.php?idFuncionario=<?php echo $dados['idFuncionario'];?> '><input class="btn btn-danger" name='deletar' type='submit' value='Deletar' ></a>
		  </td>
        </tr>
<?php }
	}
