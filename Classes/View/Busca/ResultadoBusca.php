  ...
  <body>
	...
	<?php
		...
		<?php
			  ...
			  $resultado = $dalProduto->localizarProdutoPalavra($buscar);
		...
		{ ?>
			<tr>
			  <td align="center">
				  <a class="dropdown-item" href='../Loja/produto.php?idProduto=<?php echo $dados['idProduto'];?>'>
				  	<?php echo $dados['nome']; ?>
				  </a>
			  </td>
			  <td align="center">
				  <a class="dropdown-item" href='../Loja/produto.php?idProduto=<?php echo $dados['idProduto'];?>'>
				  	<?php echo $dados['publicoAlvo']; ?>
				  </a>
			  </td>
			  <td align="center">
				  <a class="dropdown-item" href='../Loja/produto.php?idProduto=<?php echo $dados['idProduto'];?>'><img class="rounded-circle" width="70" height="70" src='../../../imagens/<?php echo $dados['imagem'];?>'/>
				  </a>
			  </td>
			</tr>
