...
if(isset($_SESSION['usuarioAcessoNiveis']) && $_SESSION['usuarioAcessoNiveis'] != null && $_SESSION['usuarioAcessoNiveis'] == 'Gerente')
{
  ...
  <body>
	...
	<?php
		...
		$resultado = $dalEmpresa->listarEmpresa();
		...
		{ $contador = $contador + 1; ?>
			<tr>
			  ...
			  <td align="center">
				<a href='../Alterar/AlterarEmpresa.php?idEmpresa=<?php echo $dados['idEmpresa'];?> '><input class="btn btn-primary" name='alterar' type='submit' value='alterar' ></a>
			  </td>
			  <td align="center">

			<!--	<a onclick="return conf();" href='ListaUsuarioInf.php?idPessoa=<?php echo $dados['idEmpresa'];?> '><input name='deletar' type='submit' value='Deletar' ></a> -->  

				<a onclick="return conf();" href='ListaEmpresaDel.php?idEmpresa=<?php echo $dados['idEmpresa'];?> '><input class="btn btn-danger" name='deletar' type='submit' value='Deletar' ></a>
			  </td>
			</tr>
