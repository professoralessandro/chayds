...
if (isset($accessToken)) {
	...
	$loginUrl = $helper->getLoginUrl('https://localhost/Classes/View/Posts/FacebookPosts.php', $permissions);
  ...
  <body>
	...
	<div class="col-md-4 pb-1 pb-md-0">
        <div class="card"><img src='<?php echo $imagem;?>' width="299" height="290" class="card-img-top rounded">
			...
			{ ?>
				<div class="dropdown-divider"></div>
				<h4 class="card-title"><?php echo $comentario; ?></a></h4>
				</div>
		<?php
			}
