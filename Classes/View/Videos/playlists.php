...
$url ='https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId='.$canalId.'&key='.$tokenAcesso;
...
<html lang="en">
  ...
  <body>
    ...
    <hr>
    <h2 class="text-center">VÍDEOS YOUTUBE <img src="../../../images/quanto-custa-anunciar-no-youtube.png" title="Youtube" width="65" height="40" ></h2>
    <hr>
    <div class="container">
	...
	<div class="col-md-4 pb-1 pb-md-0">
          <div class="card">
			<img src='<?php echo $imagem;?>' title="<?php echo $titulo;?>" width="299" height="150" class="card-img-top rounded"></a>
            <div class="card-body">
              <h5 class="card-title"><?php echo $titulo; ?></h5>
              <p class="card-text"><?php echo $canal; ?><br>
            </div>
		  </div>
			</form>
        </div>
